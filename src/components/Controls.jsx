...
const Controls = ({ mode, setMode, params, onParamChange, onRun, onReset, isPlaying }) => {
    const showMetaSettings = ['geneticAlgorithm', 'simulatedAnnealing', 'tabuSearch', 'antColony'].includes(params.algorithm) ||
        (mode === 'benchmark' && params.selectedAlgorithms.some(a => ['geneticAlgorithm', 'simulatedAnnealing', 'tabuSearch', 'antColony'].includes(a)));
                ...
                {mode === 'visualizer' ? (
                    ...
                    >
                        ...
                        <optgroup label="Exact">
                            <option value="bruteForce">Brute Force (Naive)</option>
