        ...
        <div className="space-y-6">
                ...
                {mode === 'visualizer' ? (
                    ...
                    >
                        ...
                        <optgroup label="Exact">
                            ...
                            <option value="ilp">ILP (Integer Linear Programming)</option>
                        </optgroup>
                    ...
                    <div className="space-y-2 bg-slate-900 p-2 rounded border border-slate-700 max-h-48 overflow-y-auto">
                        {[
                            ...
                            { id: 'ilp', label: 'ILP (Integer Linear Programming)' },
            ...
            <div className="space-y-4">
                ...
                {params.algorithm === 'geneticAlgorithm' && (
                    <>
                        ...
                        <div>
                            <div className="flex justify-between mb-1">
                                <label className="text-xs font-semibold text-slate-400">Generations</label>
                                <span className="text-xs text-slate-200">{params.generations}</span>
                            </div>
                            <input
                                type="range"
                                min="100"
                ...
                {params.algorithm === 'simulatedAnnealing' && (
                    <div>
                        <div className="flex justify-between mb-1">
            ...
            <div className="grid grid-cols-2 gap-2">
                <button
                    onClick={onRun}
                    disabled={isPlaying}
                    className={`py-2 rounded text-sm font-medium transition-colors ${isPlaying
                ...
                <button
                    onClick={onReset}
                    className="bg-slate-700 hover:bg-slate-600 text-white py-2 rounded text-sm font-medium transition-colors"
                >
                    Reset
                </button>
            </div>
